...
export class ConfirmationCodeInput extends Component {
  ...
  _onInputCode(character, index) {
    ...
    this.setState(
      prevState => {
        return {
          codeArr: newCodeArr,
          currentIndex: prevState.currentIndex >= 3 ? prevState.currentIndex : prevState.currentIndex + 1,
        };
      },
      () => {
  ...
  render() {
    ...
    return (
      <View style={[styles.container, this._getContainerStyle(size, inputPosition), containerStyle]}>{codeInputs}</View>
    );
  }
}
